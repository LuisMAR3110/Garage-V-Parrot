...
<section class="content-employe">
    ...
    <br>
    <p>Faites des modifications sur le contenu du site en utilisant les boutons ci-dessous. Si vous ne trouvez pas 
        la fonctonnalité qui vous intéresse, veuillez demander les droits de modification à l'administrateur.
    </p>
    <br>
    <div class="modifs-employes">
    <button class="bouton-employe"><a href="modifier-horaires.php">Modifier les horaires</a></button>
    <br>
    <button class="bouton-employe"><a href="modifier-services.php">Ajouter un service</a></button>
    <br>
    </div>
    <hr>
