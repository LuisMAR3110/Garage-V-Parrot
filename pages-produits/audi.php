...
<head>
    ...
    <title>Audi année 2015 en vente</title>
</head>
<body>
    <header>
    ...
    <div class="photo">
        <img src="../images/audi.jpg" class="image-principale" alt="Une voiture Audi bleue">
    </div>
    <div class="infos-produit">
        <h2 id="titreVoiture"><?php foreach($nomAudi as $nameAudi){
                echo $nameAudi['nom_voiture'];} ?></h2>
        <hr>
        <p class="prix">Prix : <?php foreach($prixAudi as $priceAudi){
                echo $priceAudi['prix'];} ?> €</p>
        <p>Année : <?php foreach($yearAudi as $anneeAudi){
                echo $anneeAudi['year_car'];} ?></p>
        <p>Kilométrage : <?php foreach($kmAudi as $AudiKm){
                echo $AudiKm['km'];} ?> km</p>
        <br>
        ...
        <table class="caracteristique-technique">
            <tr>
                ...
                <td><?php foreach($couleurAudi as $colorAudi){
                echo $colorAudi['couleur_car'];} ?></td>
            </tr>
            <tr>
                <td class="caracteristique">Carburant</td>
                <td><?php foreach($carburantAudi as $fuelAudi){
                echo $fuelAudi['carburant'];} ?></td>
            </tr>
            <tr>
                <td class="caracteristique">Nombre de portes</td>
                <td><?php foreach($portesAudi as $porteAudi){
                echo $porteAudi['nombre_portes'];} ?></td>
            </tr>
            <tr>
                <td class="caracteristique">Boite de vitesses</td>
                <td><?php foreach($BVAudi as $gearAudi){
                echo $gearAudi['boite_vitesses'];} ?></td>
            </tr>
            <tr>
                <td class="caracteristique">Puissance moteur</td>
                <td><?php foreach($chAudi as $powerAudi){
                echo $powerAudi['puissance_moteur'];} ?></td>
            </tr>
        </table>
    </div>
    </section>
    ...
    <div class="photo-gallery">
        ...
        <div class="gallery">
            <figure>
                <img src="../images/audi.jpg" class="image-principale" alt="Une voiture BMW noire">
            </figure>
            <figure>
                <img src="../images/audi.jpg" class="image-principale" alt="Une voiture BMW noire">
            </figure>
            ...
            <fieldset>
                ...
                <div class="input">
                    ...
                    <select id="sujet-liste" name="sujet">
                        <option value=""><?php echo $displayNomAudi; ?></option>
                    </select>
                </div>
                <div class="input">
