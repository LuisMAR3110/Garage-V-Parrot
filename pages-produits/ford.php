...
<head>
    ...
    <title>Ford d'ocassion à vendre</title>
</head>
<body>
    <header>
    ...
    <div class="photo">
        <img src="../images/ford.jpg" class="image-principale" alt="Une voiture Ford grise">
    </div>
    <div class="infos-produit">
        <h2><?php foreach($nomFord as $nameFord){
                echo $nameFord['nom_voiture'];} ?></h2>
        <hr>
        <p class="prix">Prix : <?php foreach($prixFord as $priceFord){
                echo $priceFord['prix'];} ?> €</p>
        <p>Année : <?php foreach($yearFord as $anneeFord){
                echo $anneeFord['year_car'];} ?></p>
        <p>Kilométrage : <?php foreach($kmFord as $FordKm){
                echo $FordKm['km'];} ?> km</p>
        <br>
        ...
        <table class="caracteristique-technique">
            <tr>
                ...
                <td><?php foreach($couleurFord as $colorFord){
                echo $colorFord['couleur_car'];} ?></td>
            </tr>
            <tr>
                <td class="caracteristique">Carburant</td>
                <td><?php foreach($carburantFord as $fuelFord){
                echo $fuelFord['carburant'];} ?></td>
            </tr>
            <tr>
                <td class="caracteristique">Nombre de portes</td>
                <td><?php foreach($portesFord as $porteFord){
                echo $porteFord['nombre_portes'];} ?></td>
            </tr>
            <tr>
                <td class="caracteristique">Boite de vitesses</td>
                <td><?php foreach($BVFord as $gearFord){
                echo $gearFord['boite_vitesses'];} ?></td>
            </tr>
            <tr>
                <td class="caracteristique">Puissance moteur</td>
                <td><?php foreach($chFord as $powerFord){
                echo $powerFord['puissance_moteur'];} ?></td>
            </tr>
        </table>
    </div>
    </section>
    ...
    <div class="photo-gallery">
        ...
        <div class="gallery">
            <figure>
                <img src="../images/ford.jpg" class="image-principale" alt="Une voiture BMW noire">
            </figure>
            <figure>
                <img src="../images/ford.jpg" class="image-principale" alt="Une voiture BMW noire">
            </figure>
            ...
            <fieldset>
                ...
                <div class="input">
                    ...
                    <select id="sujet-liste" name="sujet">
                        <option value=""><?php echo $displayNomFord; ?></option>
                    </select>
                </div>
                <div class="input">
